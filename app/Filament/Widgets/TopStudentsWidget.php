...
{
    protected static ?string $heading = 'Peringkat 5 Siswa Tertinggi';
    ...
    public function table(Table $table): Table
    {
        ...
        // Ambil ID 5 tertinggi
        $ids = (clone $baseQuery)->orderByDesc('rata_rata_skor')->limit(5)->pluck('id')->toArray();
        ...
        return $table
            ...
            ->defaultSort('rata_rata_skor', 'desc')
            ->paginated(false);
    }
}
